...
let ukrWords07092020 = "Спілкуватися спілкування телекомунікації передавати спосіб_передавання передавач отримати приймач приймач-передавач нести перевізник конвертувати перетворення перетворювач для_посилення посилення підсилювач окружність схема турбувати порушення розгром маршрутизатор використовувати користувач повторювати ретранслятор послабити загасання розрізняти відмінні відрізнити нерозрізнений розділити поділ підрозділ часті часто частота ідеально досконалість недосконалий недосконалість виділити/локалізувати виділений/локалізований розподіл/локалізація ключ маніпуляції";
